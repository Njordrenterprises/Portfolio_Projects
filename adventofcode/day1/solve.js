...
function processFile(filePath) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, sum, _d, rl_1, rl_1_1, line, e_1_1;
...
function getCalibrationValue(line) {
    ...
    var numberRegex = new RegExp("\\b(".concat(Object.keys(numberWords).join('|'), ")\\b|\\d"), 'gi');
    var matches = [];
...
processFile('input.txt').then(function (sum) {
    console.log("The sum of all calibration values is: ".concat(sum));
